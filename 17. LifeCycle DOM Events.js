...
//____________________ Slider Component  _______________________
/* #region  Slider Component */
const slides = document.querySelectorAll('.slide');
const slider = document.querySelector('.slider');
const btnRight = document.querySelector('.slider__btn--right');
const btnLeft = document.querySelector('.slider__btn--left');
const dotContianer = document.querySelector('.dots');
let curSlide = 0;
...
//======== Advance Slider =======
//===============================
/* #region  Advance Slider */

// //Dots
// const createDots = function(){
//     slides.forEach(function(_,i){
//         dotContianer.insertAdjacentHTML('beforeend',`
...
// })
// //delegation
// dotContianer.addEventListener('click',function(e){
...
//===============================
//=== Refector Advance Slider ===
//===============================
/* #region  Refectore Advance_Slider */
function Slider() {
  const createDots = function () {
    slides.forEach(function (_, i) {
      dotContianer.insertAdjacentHTML(
        'beforeend',
        `
                <button class="dots__dot" data-slide="${i}"></button>
                `
...
//____________________ LifeCycle DOM  _______________________
/* #region  LifeCycle DOM in Js */
//LifeCycle DOM  means Operation   from Start to end
//1. When the user loaded the page
//2. After at the end of Leaveing the page

//------ 1. DOMConentLoaded Event --------
//when then all html is loaded in DOM then trigger
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML Parse and DOM Tree Built successfully', e);
});

//------ 2. Document.Ready (Jquyer) --------
//this is Equilient to   DOMContentLoaded
...
//------ 4. OntheLeaveWindow beforeunload Event --------
// window.addEventListener("beforeunload",function(e){
//     console.log("when try to leave",e);
//     e.preventDefault();
//     e.returnValue = "";  //In new feuture   value is not return its remove in propmpt
//     //in prompt  default values will displayed
// })
//used when user leave the midle of form submit to restrick him that your form will be lost
/* #endregion */
